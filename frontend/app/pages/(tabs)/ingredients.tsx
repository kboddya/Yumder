...
const styles = StyleSheet.create({
    safeArea: { flex: 1, backgroundColor: '#f5f5ff5' }, scrollContainer: { paddingBottom: 120 }, header: { paddingTop: 70, paddingHorizontal: 20, marginBottom: 20 }, headerCard: { backgroundColor: 'rgba(255, 255, 255, 0.90)', borderRadius: 20, padding: 25, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.5)' }, headerTitle: { fontSize: 38, fontWeight: 'bold', color: '#854d0e' }, card: { marginHorizontal: 20, marginBottom: 20, backgroundColor: 'rgba(255, 255, 255, 0.85)', borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.5)', overflow: 'hidden' }, sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20, paddingBottom: 10 }, sectionTitle: { fontSize: 22, fontWeight: 'bold', color: '#333' }, viewAllText: { fontSize: 14, color: '#d97706', fontWeight: '600' }, itemRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, paddingHorizontal: 20 }, itemText: { fontSize: 18, color: '#333' }, itemImage: { width: 50, height: 50, borderRadius: 8, marginRight: 15, backgroundColor: '#f0f0f0' }, separator: { height: 1, backgroundColor: 'rgba(220, 220, 220, 0.5)', marginLeft: 20, },
});